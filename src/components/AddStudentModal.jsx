...
export default function AddStudentModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: "", marks: "", attendance: "" });
    onClose();
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#121212] border border-[#222] text-white rounded-xl pl-12 pr-4 py-3 outline-none focus:border-[#22C55E]"
                  />
                </div>
              </div>
              ...
              <button type="submit" className="w-full mt-4 bg-[#22C55E] hover:bg-[#1db954] text-black font-bold py-3.5 rounded-xl transition-all shadow-[0_0_15px_rgba(34,197,94,0.15)]">
                Save Student
              </button>
            </form>
          </motion.div>
